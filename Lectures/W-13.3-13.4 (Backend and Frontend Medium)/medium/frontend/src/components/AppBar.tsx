  ...
  return (
    <div className='px-6 py-2 flex  justify-between items-center border-b-2 shadow-md'>
      ...
      <div className='flex gap-2 pr-2 items-center'>
        ...
        <div className={`${visible} relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 hover:bg-gray-300 rounded-full cursor-pointer`}>
